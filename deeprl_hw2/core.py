...
class Preprocessor:
    ...
    def process_state_for_memory(self, state):
        ...
        ----------
        state: np.ndarray
          A single state from an enviroment. Generally a numpy array.
...
class ReplayMemory:
    ...
    end_episode(final_state, is_terminal, debug_info=None)
      ...
      terminal state (i.e. the env returned is_terminal=True), or if
      it is an artificial terminal state (i.e. agent quit the episode
